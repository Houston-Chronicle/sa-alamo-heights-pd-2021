...
raw_2012 <- read_excel("Data/AHPD 2012 Incidents SAEN 01202022.xls", skip = 5)
raw_2013 <- read_excel("Data/AHPD 2013 Incidents SAEN 01202022.xls", skip = 5)
raw_2014 <- read_excel("Data/AHPD 2014 Incidens SAEN 01202022.xls", skip = 5)
raw_2015 <- read_excel("Data/AHPD 2015 Incidents SAEN 01202022.xls", skip = 5)
raw_2016 <- read_excel("Data/AHPD 2016 Incidents SAEN 01202022.xls", skip = 5)
raw_2017 <- read_excel("Data/AHPD 2017 Incidents SAEN 01202022.xls", skip = 5)
raw_2018 <- read_excel("Data/AHPD 2018 Incidents SAEN 01212022.xls", skip = 5)
raw_2019 <- read_excel("Data/AHPD 2019 Incidents SAEN 01212022.xls", skip = 5)
raw_2020 <- read_excel("Data/AHPD 2020 Incidents SAEN 01212022.xls", skip = 5)
raw_2021 <- read_excel("Data/AHPD 2021 Incidents SAEN 01212022.xls", skip = 5)
```
